def grades():
    ...
    print(f"El promedio de las tres notas: {promedio}")
    print(f"La nota max: {nota_max}")
    print(f"La nota min: {nota_min}")
    print(f"Cuantos puntos faltan del promedio a 10: {puntos_faltantes}")
